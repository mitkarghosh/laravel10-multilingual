...
$(document).ready(function() {
    ...
    // Start :: Feedback Question Form //
    $("#createFeedbackQuestionForm").validate({
        ignore: ":hidden",
        debug: false,
        rules: {
            question: {
    ...
    $("#updateFeedbackQuestionForm").validate({
        ignore: ":hidden",
        debug: false,
        rules: {
            question: {
    ...
    $("#createEventForm").validate({
        ...
        messages: {
            ...
            advertiser_id: {
                required: "Please select entrepreneur.",
            },
            title: {
                required: "Please enter title.",
            },
    ...
    $("#replyForm").validate({
        ...
        submitHandler: function(form) {
            $('#btn-sending').html(btnSendingPreloader);
            $('.preloader').show();
            form.submit();
        }
    });
